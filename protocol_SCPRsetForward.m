...
if (intermeet_node_direct >= nodeIndex_direct) && (intermeet_node_trans(1) >= nodeIndex_trans(1)) && (intermeet_node_trans(2) >= nodeIndex_trans(2)) && (intermeet_node_trans(3) >= nodeIndex_trans(3))
