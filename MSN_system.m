...
MN_DATA_SOCIA = MSN_CALCULATE4(input_settings,MN_DATA,10,1.5,'Epidemic'); %null协议无需计算HOP 使用2减少计算  

% 路由结果        数据结果          %para:仿真初始化     节点数据  路由表数据     路由协议  仿真时长 与初始化，移动模型相同 
[MN_DATA_ROUTING, Report] = MSN_ROUTING(input_settings, MN_DATA, MN_DATA_SOCIA, 'Epidemic', 15);
