...
MN_DATA_INIT = MN_INIT(input_settings,AREA_DATA,2); %用于初始化移动节点的家与主任务，后续仿真中不改变该值
...
[MN_DATA_ROUTING Report] = MSN_ROUTING(input_settings, MN_DATA, ROUTING_TABLE, 'OTHER', 2);
